...
func (c *fluentdConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.FluentdConfig, err error) {
...
func (c *fluentdConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.FluentdConfigList, err error) {
...
func (c *fluentdConfigs) Create(ctx context.Context, fluentdConfig *v1beta1.FluentdConfig, opts v1.CreateOptions) (result *v1beta1.FluentdConfig, err error) {
	result = &v1beta1.FluentdConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("fluentdconfigs").
...
func (c *fluentdConfigs) Update(ctx context.Context, fluentdConfig *v1beta1.FluentdConfig, opts v1.UpdateOptions) (result *v1beta1.FluentdConfig, err error) {
	result = &v1beta1.FluentdConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fluentdconfigs").
...
func (c *fluentdConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.FluentdConfig, err error) {
	result = &v1beta1.FluentdConfig{}
